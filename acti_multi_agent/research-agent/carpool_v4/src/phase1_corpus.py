...
CATEGORY_KEYWORDS = {
    "A": {
        "anchors": [
            "small town", "small-town", "rural", "college campus", "university campus",
            "campus transportation", "rideshare gap", "uber availability",
        ],
        "secondary": [
            "mobility access", "transportation gap", "campus shuttle", "rideshare",
            "pricing", "availability", "coverage", "underserved",
        ],
    },
    "B": {
        "anchors": [
            "peer-to-peer ridesharing", "p2p rideshare", "sharing economy",
            "airbnb", "uber trust", "identity verification",
        ],
        "secondary": [
            "reputation", "trust signal", "stranger trust", "personal photos",
            "profile", "review", "online platform",
        ],
    },
    "C": {
        "anchors": [
            "wechat", "whatsapp", "messaging app", "group chat",
            "informal coordination", "grassroots", "self-organized",
        ],
        "secondary": [
            "community platform", "informal infrastructure", "digital coordination",
            "instant messaging", "group coordination",
        ],
    },
    "D": {
        "anchors": [
            "international students", "chinese students", "digital acculturation",
            "immigrant students", "cross-cultural",
        ],
        "secondary": [
            "us university", "american campus", "foreign students",
            "student community", "social media use",
        ],
    },
    "E": {
        "anchors": [
            ".edu", "edu email", "institutional identity", "campus-scoped",
            "closed community", "institutional verification",
        ],
        "secondary": [
            "identity verification", "campus id", "credential",
            "institutional trust", "membership verification",
        ],
    },
    "F": {
        "anchors": [
            "rideshare safety", "real-time location", "sos", "emergency button",
            "women safety", "mobility safety", "shared mobility risk",
        ],
        "secondary": [
            "panic button", "location sharing", "trip sharing",
            "safety feature", "emergency contact", "ride tracking",
        ],
    },
    "G": {
        "anchors": [
            "gamification", "points system", "carpool incentive",
            "mobility rewards", "behavioral change",
        ],
        "secondary": [
            "badges", "achievements", "leaderboard", "engagement",
            "intrinsic motivation", "extrinsic reward",
        ],
    },
    "H": {
        "anchors": [
            "rating fairness", "peer rating", "reputation system",
            "rating bias", "algorithmic management",
        ],
        "secondary": [
            "review system", "driver rating", "rating anxiety",
            "feedback design", "rating dispute", "reputation",
        ],
    },
    "I": {
        "anchors": [
    ...
    "J": {
        "anchors": [
            "algorithmic management", "platform labor", "gig economy",
            "driver precarity", "platform-mediated work",
        ],
        "secondary": [
            "gig worker", "algorithmic control", "algorithmic opacity",
            "worker wellbeing", "platform critique", "labor precarity",
        ],
    },
}
...
CATEGORY_GROUP_RULES = {
    "A": [
        ["small town", "small-town", "rural", "university", "college campus"],
        ["rideshare", "uber", "lyft", "transportation", "mobility"],
        ["gap", "underserved", "availability", "access", "pricing"],
    ],
    "B": [
        ["peer-to-peer", "p2p", "sharing economy", "airbnb", "uber", "platform economy"],
        ["trust", "reputation", "identity", "verification", "signal"],
    ],
    "C": [
        ["wechat", "whatsapp", "messaging", "group chat", "line app"],
        ["community", "coordination", "informal", "grassroots", "self-organized"],
    ],
    "D": [
        ["international students", "chinese students", "foreign students", "immigrant"],
        ["us university", "american campus", "united states"],
        ["digital", "social media", "platform", "wechat"],
    ],
    "E": [
        [".edu", "edu email", "institutional", "campus id", "campus-scoped", "closed community"],
        ["identity verification", "credential", "membership", "trust signal"],
    ],
    "F": [
        ["rideshare", "carpool", "mobility", "vehicle"],
        ["safety", "real-time location", "sos", "emergency", "risk mitigation"],
    ],
    "G": [
        ["gamification", "points", "badges", "leaderboard", "rewards"],
        ["mobility", "carpool", "coordination", "behavioral change"],
    ],
    "H": [
        ["rating", "reputation", "feedback", "review"],
    ...
    "J": [
        ...
        ["critique", "precarity", "opacity", "worker wellbeing", "control"],
    ],
}
...
def _run_arxiv_search(arxiv: ArxivClient, queries_cfg: dict, raw_dir: str) -> list[dict]:
    ...
    arxiv_queries_raw = queries_cfg.get("arxiv_queries", [
        {"query": 'all:"rideshare" AND all:"small town"'},
        {"query": 'all:"peer-to-peer ridesharing" AND all:"trust"'},
        {"query": 'all:"algorithmic management" AND all:"gig worker"'},
        {"query": 'all:"rating fairness" AND all:"platform"'},
        {"query": 'all:"international students" AND all:"digital practices"'},
    ])
